...
export const TypingIndicator: React.FC<TypingIndicatorProps> = ({
  ...
  return (
    <div className="flex items-end justify-start mb-4 typing-indicator-row">
      <div
        className={`w-6 h-6 mr-2 flex-shrink-0 self-start mt-1 flex items-center justify-center rounded-full typing-avatar ${
      ...
      <div
        className={`px-4 py-2 rounded-2xl rounded-bl-none shadow-sm typing-bubble ${
